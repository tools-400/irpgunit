...
public class SpooledFileSaveAsHTMLAction extends AbstractSpooledFileAction {
    ...
    public static final String ID = "de.tools400.rpgunit.isphere.action.SpooledFileSaveAsHTMLAction"; //$NON-NLS-1$

    @Override
    public String execute(SpooledFile spooledFile) throws CanceledByUserException {
        return spooledFile.saveWithCancelOption(getShell(), IPreferences.OUTPUT_FORMAT_HTML);
    }
}
