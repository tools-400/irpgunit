...
public class SpooledFileOpenAsTextAction extends AbstractSpooledFileAction {
    ...
    public static final String ID = "de.tools400.rpgunit.isphere.action.SpooledFileOpenAsTextAction"; //$NON-NLS-1$

    @Override
    public String execute(SpooledFile spooledFile) throws CanceledByUserException {
        return spooledFile.open(IPreferences.OUTPUT_FORMAT_TEXT);
    }
}
