...
package de.tools400.rpgunit.spooledfileviewer.command.states;
...
public class DisplayReportCommandState extends AbstractSourceProvider {
    public final static String STATE = "de.tools400.rpgunit.spooledfileviewer.commands.state.displayreport.enabled"; //$NON-NLS-1$
