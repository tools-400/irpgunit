...
public class Messages extends NLS {
    ...
    public static String Description_of_service_program_does_not_start_with_A_or_B;
    public static String User_defined_attribute_of_service_program_is_not_set_to_A_or_B;
    ...
    public static String Actual_length;
    public static String Actual_original_length;
    public static String Actual_data_type;
    public static String Actual_assertion_procedure;
